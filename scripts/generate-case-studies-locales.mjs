  ...
  shared: {
    process: {
      ...
      steps: {
        discovery: {
          title: 'Discovery',
          description: 'Zmapowaliśmy cele, flow użytkownika, ograniczenia i edge case’y przed kodem.',
        },
    ...
    cta: {
      p2p: {
        title: 'Budujesz produkt P2P lub marketplace?',
        subtitle: 'Porozmawiajmy o Twoim pomyśle.',
        button: 'Napisz do nas',
      },
      community: {
        title: 'Budujesz platformę społecznościową?',
        subtitle: 'Porozmawiajmy o Twoim produkcie.',
        button: 'Napisz do nas',
      },
      logistics: {
        title: 'Budujesz produkt logistyczny?',
      ...
      product: {
        title: 'Masz pomysł na produkt?',
        subtitle: 'Omówmy zakres, harmonogram i podejście.',
        button: 'Napisz do nas',
      },
    },
  },
  ...
  shared: {
    process: {
      ...
      steps: {
        ...
        design: {
          title: 'Design',
          description: 'UX, візуальну мову та ключові екрани відповідно до стратегії продукту.',
        },
        build: {
          title: 'Build',
          description: 'Реалізували ключові функції, інтеграції та критичні для швидкодії шляхи.',
        },
    ...
    cta: {
      ...
      community: {
        title: 'Будуєте платформу спільноти?',
        subtitle: 'Давайте обговоримо ваш продукт.',
        button: 'Написати нам',
      },
      logistics: {
      ...
      brand: {
        title: 'Потрібна айдентика бренду?',
        subtitle: 'Створимо щось запам’ятовуване.',
        button: 'Написати нам',
      },
...
const caseLocales = {
  pl: {
    yachtmate: {
      ...
      challenge:
        'Kluby jachtowe potrzebowały zamkniętej sieci, w której członkowie komunikują się bez publicznych kanałów. Wyzwanie: czat na żywo, weryfikacja i koordynacja wydarzeń za ścisłą kontrolą prywatności.',
      solution:
        'Zbudowaliśmy YachtMate z weryfikacją członków, rolami, czatem w czasie rzeczywistym i narzędziami eventowymi. React i Node.js zapewniają niskie opóźnienia przy zachowaniu prywatności danych.',
    },
    sharingground: {
      meta: {
      ...
      stats: {
        ...
        deliverables: { label: 'Zakres', value: 'Design + Dev' },
        platform: { label: 'Platforma', value: 'Web + Mobile' },
      },
      challenge:
        'Platforma sharingowa, gdzie nieznajomi powierzają sobie rzeczy. Jak zapewnić odpowiedzialność i rozwiązywać spory bez bycia pośrednikiem w każdej transakcji?',
      solution:
        'Warstwa zaufania: weryfikacja, logi stanu, ubezpieczenie, opinie. Płatności w escrow do potwierdzenia wymiany przez obie strony.',
    },
    profitcraft: {
      meta: {
      ...
      challenge:
        'Nowi mieszkańcy USA nie znają roli kredytu. Potrzebna była strona budująca zaufanie i konwertująca bez żargonu.',
    ...
    navexa: {
      ...
      stats: {
        ...
        deliverables: { label: 'Zakres', value: 'Development + Marketing' },
        platform: { label: 'Platforma', value: 'Web' },
      },
      challenge:
        'Jeden system operacyjny oraz marketing, który jasno komunikuje wartość platformy i przyciąga klientów B2B.',
    ...
    mie: {
      ...
      stats: {
        ...
        deliverables: { label: 'Zakres', value: 'Development' },
        platform: { label: 'Platforma', value: 'iOS + Android' },
      },
    ...
    'ortvest-logo': {
      ...
      stats: {
        projectType: { label: 'Typ projektu', value: 'Logo' },
        deliverables: { label: 'Zakres', value: 'Design' },
        platform: { label: 'Zakres', value: 'Digital-first' },
      },
  ...
  ua: {
    ...
    sharingground: {
      ...
      stats: {
        ...
        deliverables: { label: 'Результат', value: 'Design + Dev' },
        platform: { label: 'Платформа', value: 'Web + Mobile' },
      },
      challenge:
        'Незнайомі довіряють одне одному речі. Як забезпечити відповідальність і спори без посередництва в кожній угоді?',
      solution:
        'Шар довіри: верифікація, логи стану, страхування, відгуки. Ескроу до підтвердження обміну обома сторонами.',
    },
    profitcraft: {
      meta: {
    ...
    navexa: {
      ...
      stats: {
        ...
        deliverables: { label: 'Результат', value: 'Development + Marketing' },
        platform: { label: 'Платформа', value: 'Web' },
      },
    ...
    mie: {
      ...
      stats: {
        ...
        deliverables: { label: 'Результат', value: 'Development' },
        platform: { label: 'Платформа', value: 'iOS + Android' },
      },
    ...
    'ortvest-logo': {
      ...
      stats: {
        projectType: { label: 'Тип проєкту', value: 'Logo Design' },
        deliverables: { label: 'Результат', value: 'Design' },
        platform: { label: 'Обсяг', value: 'Digital-first' },
      },
