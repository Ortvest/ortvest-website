...
const HAS_DEPENDENCY = new Set<ModuleKey>(['orders', 'board', 'analytics', 'blog']);
...
const ADDON_ITEMS: { key: ModuleKey; price: string }[] = [
  { key: 'transactions', price: '+€10/mo' },
  { key: 'analytics', price: '+€10/mo' },
  { key: 'blog', price: '+€15/mo' },
];
    ...
    <>
      ...
      <section
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(205,255,78,0.08) 0%, transparent 70%)',
          }}
          aria-hidden
        />
        ...
        <Container>
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <motion.div
              ...
              <h1
                id="cms-hero-heading"
                className="mt-4 text-display-sm font-bold text-white sm:text-display">
                {t('hero.headline')}
              </h1>
                ...
                <nav
                  ...
                  {MODULES.map(({ key, Icon, addon }) => (
                    <button
                      ...
                      className={`mr-2 flex shrink-0 items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors lg:mb-0.5 lg:mr-0 lg:w-full ${
                        activeModule === key
                      ...
                      {addon && (
                        <span className="ml-auto hidden rounded bg-accent/15 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-accent lg:inline">
                          Add-on
                        </span>
                      )}
                    </button>
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      <ul className="mt-4 space-y-2" role="list">
                        {Array.from({ length: FEATURE_COUNT[activeModule] }, (_, i) => i + 1).map(
                          (i) => (
      ...
      <section
        ...
        aria-labelledby="cms-pricing-heading">
        <Container>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <article className="relative flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-6">
                ...
                <div className="mt-5">
                  <Link
                    href="#contact"
                    className="inline-flex h-11 items-center justify-center rounded-full border border-white/20 bg-white/5 px-5 text-sm font-semibold text-white transition-colors hover:border-white/30 hover:bg-white/10">
              ...
              <article className="relative flex flex-col overflow-hidden rounded-2xl bg-accent p-6 shadow-glow">
                ...
                {billing === 'annually' && (
                  <p className="mt-1 text-xs text-black/50">{t('pricing.billedAnnually')}</p>
                )}
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {ADDON_ITEMS.map(({ key, price }) => (
                  <div
                    ...
                    <span className="font-medium text-white">{t(`showcase.modules.${key}.name`)}</span>
      ...
      <section
        ...
        style={{ backgroundColor: HERO_BG }}
        aria-labelledby="cms-cta-heading">
        <Container>
          <SectionReveal direction="right">
