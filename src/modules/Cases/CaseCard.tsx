...
export async function CaseCard({ caseItem, compact = false }: CaseCardProps) {
  ...
  const showNicheCta = nicheKey && !caseItem.isNDA;

  const cardClassName =
    'group relative block overflow-hidden rounded-2xl border border-black/[0.08] bg-white transition hover:border-black/15 hover:shadow-card';
